...
public class AggregateMediator extends AbstractListMediator {
    ...
    public OMElement serialize(OMElement parent) {
        ...
        if (correlateExpression != null) {
            ...
            SynapsePathSerializer.serializePath(correlateExpression, corelateOn, "expression");
    ...
    public void build(OMElement elem) {
        ...
        if (corelateOn != null) {
            ...
            if (corelateExpr != null) {
                try {
                    correlateExpression = SynapsePathFactory.getSynapsePath(corelateOn, EXPRESSION_Q);
        ...
        if (onComplete != null) {
            ...
            if (aggregateExpr != null) {
                try {
                    aggregationExpression = SynapsePathFactory.getSynapsePath(onComplete, EXPRESSION_Q);
                } catch (JaxenException e) {
